<nav class="mainNav">
    <div class="navRightSection">
        <div class="logo">
            <a href="{{ route('home') }}">
                <svg viewBox="0 0 36 36" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4" fill="url(#jsc_s_16)" height="40" width="40">
                    <defs>
                        <linearGradient x1="50%" x2="50%" y1="97.0782153%" y2="0%" id="jsc_s_16">
                            <stop offset="0%" stop-color="#0062E0"></stop>
                            <stop offset="100%" stop-color="#19AFFF"></stop>
                        </linearGradient>
                    </defs>
                    <path d="M15 35.8C6.5 34.3 0 26.9 0 18 0 8.1 8.1 0 18 0s18 8.1 18 18c0 8.9-6.5 16.3-15 17.8l-1-.8h-4l-1 .8z"></path>
                    <path style="fill: #fff;" class="p361ku9c" d="M25 23l.8-5H21v-3.5c0-1.4.5-2.5 2.7-2.5H26V7.4c-1.3-.2-2.7-.4-4-.4-4.1 0-7 2.5-7 7v4h-4.5v5H15v12.7c1 .2 2 .3 3 .3s2-.1 3-.3V23h4z"></path>
                </svg>
            </a>
        </div>
        <div class="search">
            {!! Form::open(['route' => 'user.friend.search', 'method' => 'get']) !!}
                <div class="searchGroup">
                    {!! Form::text('keyword', old('keyword', Request()->keyword), ['placeholder' => 'Search Facebook']) !!}
                    {!! Form::button('<svg viewBox="0 0 16 16" width="1em" height="1em" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv gl3lb2sf hhz5lgdu">
    ...
    <div class="navLeftSection">
        <a class="personLogo" href="{{ route('user.show.profile') }}">
            <img src="{{ asset('userDashboard/images/defaultPerson.png') }}" height="28" width="28" alt="Person Image">
            <span>{{ auth()->user()->username }}</span>
        </a>
        <div class="styleSvg">
            <svg viewBox="0 0 44 44" width="1em" height="1em" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry jnigpg78 odw8uiq3"><circle cx="7" cy="7" r="6"></circle><circle cx="22" cy="7" r="6"></circle><circle cx="37" cy="7" r="6"></circle><circle cx="7" cy="22" r="6"></circle><circle cx="22" cy="22" r="6"></circle><circle cx="37" cy="22" r="6"></circle><circle cx="7" cy="37" r="6"></circle><circle cx="22" cy="37" r="6"></circle><circle cx="37" cy="37" r="6"></circle></svg>
        </div>
        <div class="styleSvg">
        ...
        <div onclick="myFunction()" class="styleSvg">
        ...
        <div onclick="accountSetting()" class="styleSvg">
            <svg viewBox="0 0 20 20" width="1em" height="1em" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry jnigpg78 odw8uiq3"><path d="M10 14a1 1 0 0 1-.755-.349L5.329 9.182a1.367 1.367 0 0 1-.205-1.46A1.184 1.184 0 0 1 6.2 7h7.6a1.18 1.18 0 0 1 1.074.721 1.357 1.357 0 0 1-.2 1.457l-3.918 4.473A1 1 0 0 1 10 14z"></path></svg>
        </div>
    </div>
</nav>

<!-- Start NotificationSystem -->
<div class="notificationsystem" id="notification">
    <div class="topNot">
        <h5>Notification</h5>
        <a class="topNotLink" href="#">...</a>
    </div>
    <div topNotMid>
        <span class="topNotMidf">
            <a href="#">All</a>
        </span>
        <span class="topNotMidl">
            <a href="#">Un Read</a>
        </span>
    </div>
    <h5>Friendship requests</h5>
    @isset ($userNotifications)
        @forelse ($userNotifications as $userNotification)
        <div class="notFruendReq">
            <div class="notFruendReqWrap">
                <div class="photoHolder">
                    <img src="{{ asset('userDashboard/images/photoRequst.jpg') }}" alt="photo request">
                    <i class="requestIcon"></i>
                </div>
                <div>
                    <p>send to you <a href="#">MohamedAlmalek</a> Friendship request</p>
                    <div class="accepteRemove">
                        <a href="{{ route('user.accepte.friend', $userNotification->user_id_sender) }}">Accepte</a>
                        <a href="{{ route('user.removefriend', $userNotification->user_id_sender) }}">Remove</a>
                    </div>
                </div>
            </div>
        </div>
        @empty
            <h4>No Friend Request Found</h4>
        @endforelse
    @endisset
        </div>
<!-- End NotificationSystem -->
<div class="accountControllerSetting" id="accountController">
    <a href="{{ route('user.show.profile') }}">
        <img src="{{ asset('userDashboard/images/profilePerson.png') }}" width="60" height="60" alt="profile image">
        <div class="info accountIfnoFirst">
            <h5>Mohamed Maghraby</h5>
            <p>See your profile</p>
        </div>
    </a>
    <hr>

    <a href="#" class="giveFeedback">
        <div class="giveFeedbackIcon">
            <i></i>
        </div>
        <div class="info accountIfnoFirst">
            <h5>Give feedback</h5>
    ...
    <a href="#" class="accountControllerSpaceBetween">
        <div class="displayflex">
            <img src="{{ asset('userDashboard/images/personInSearch.jpg') }}" width="40" height="40" alt="switch account">
    ...
    <a href="#" class="accountControllerSpaceBetween">
        <div class="displayflex">
            <div class="giveFeedbackIcon">
                <i class="displayAccessibbility"></i>
            </div>
            <h5>Display & Accessibility</h5>
        </div>
        <i class="right-arrow"></i>
    </a>
    <a class="accountControllerSpaceBetween" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
        <div class="displayflex">
            <div class="giveFeedbackIcon">
                <i class="logout"></i>
            </div>
