            ...
            <div class="notFruendReqWrap">
                ...
                <div>
                    ...
                    <div class="accepteRemove">
                        {!! Form::open(['route' => 'user.accepte.friend', 'method' => 'post']) !!}
                            {!! Form::button('Accepte', ['type' => 'submit']) !!}
                        {!! Form::close() !!}
                        {!! Form::open(['route' => 'user.remove.friend', 'method' => 'post']) !!}
                            {!! Form::button('remove', ['type' => 'submit']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
